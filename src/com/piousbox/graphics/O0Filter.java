 ...
 * @author ae1
 */
public class O0Filter extends Image {
    ...
    public O0Filter(BufferedImage img, Config config) {
...
//                    System.out.println("difference is: "+ D);
    ...
    public O0Filter(BufferedImage img, int p, int thresh, int nBlobs) {
...
class Blob {
    ...
    void addPt(int idxX, int idxY) {
        pts.add(new Point(idxX, idxY));
        // System.out.println("point added: "+ idxX +" "+ idxY);
    }
